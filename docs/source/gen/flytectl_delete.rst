...
Terminates/deletes various Flyte resources such as tasks, workflows, launch plans, executions, and projects.
...
* :doc:`flytectl_delete_execution` 	 - Terminates/deletes execution resources.
